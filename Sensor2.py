...
class SecondSolarPanel:
     ...
     def publish(client : Client, day: int, weather: int):
          ...
          client.publish("solarPanel2/temperature", temperature)
          client.publish("solarPanel2/production", production)
          client.publish("solarPanel2/light", light)